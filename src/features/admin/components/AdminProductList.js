...
export default function AdminProductList() {
  ...
  const handleFilter = (e, section, option) => {
    ...
    //If user is selecting checkbox add those property else delete those
    if (e.target.checked) {
              ...
              ? products.map((product) => (
                  <div key={product.id}>
                    <Link to={`/product-detail/${product.id}`}>
                      <div className="group relative p-2 border-solid border-2 border-gray-300 rounded-md shadow-sm shadow-gray-200 hover:shadow-gray-400">
